...
for compare = 1:data_count
    ...
    current_source_img_reference = data{compare,1};          % non-cropped finger image
    ...
    img_mec_bin_reference = data{compare,7};                 % MEC skeletonized
    ...
    for compare_with = 1:data_count
        ...
        % read all data for first database entry
        current_source_img = data{compare_with,1};          % non-cropped finger image
        ...
        img_mec_bin = data{compare_with,7};                 % MEC skeletonized
