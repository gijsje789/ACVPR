...
% give latest optimal thresholds (check with evaluate_algorithm.m) in %
RL_TEMPLATE_THRESHOLD = 30;
RL_DISTANCE_THRESHOLD = 93;
MAC_TEMPLATE_THRESHOLD = 7;
MAC_DISTANCE_THRESHOLD = 90;
MEC_TEMPLATE_THRESHOLD = 30;
MEC_DISTANCE_THRESHOLD = 60;
LBP_THRESHOLD = 1;
    ...
    if(~(person == person_reference && finger == finger_reference && number == number_reference))
        ...
        if strcmp(test_method,'RL')
            if strcmp(match_method, 'template')
                ...
                if full_match_percentage > RL_TEMPLATE_THRESHOLD
                    position =  [0 0];
            ...
            elseif strcmp(match_method, 'distance')
                ...
                if full_match_percentage > RL_DISTANCE_THRESHOLD
                    position =  [0 0];
                    value = ['Person: ' num2str(person), ', finger: ' num2str(finger), ', photo: ' num2str(number), '        (', num2str(round(full_match_percentage,1)), '% match)'];
                    img = insertText(current_source_img,position,value,'AnchorPoint','LeftTop', 'fontsize', 20, 'boxcolor','black','textcolor','white');
                    figure; imshow(img);              %% MATCH FOUND!
        ...
        elseif strcmp(test_method,'MAC')
            if strcmp(match_method, 'template')
                ...
                if full_match_percentage > MAC_TEMPLATE_THRESHOLD
                    position =  [0 0];
                    value = ['Person: ' num2str(person), ', finger: ' num2str(finger), ', photo: ' num2str(number), '        (', num2str(round(full_match_percentage,1)), '% match)'];
                    img = insertText(current_source_img,position,value,'AnchorPoint','LeftTop', 'fontsize', 20, 'boxcolor','black','textcolor','white');
                    figure; imshow(img);              %% MATCH FOUND!
            ...
            elseif strcmp(match_method, 'distance')
                ...
                if full_match_percentage > MAC_DISTANCE_THRESHOLD
                    position =  [0 0];
                    value = ['Person: ' num2str(person), ', finger: ' num2str(finger), ', photo: ' num2str(number), '        (', num2str(round(full_match_percentage,1)), '% match)'];
                    img = insertText(current_source_img,position,value,'AnchorPoint','LeftTop', 'fontsize', 20, 'boxcolor','black','textcolor','white');
                    figure; imshow(img);              %% MATCH FOUND!
        ...
        elseif strcmp(test_method,'MEC')
            if strcmp(match_method, 'template')
                ...
                if full_match_percentage > MEC_TEMPLATE_THRESHOLD
                    position =  [0 0];
                    value = ['Person: ' num2str(person), ', finger: ' num2str(finger), ', photo: ' num2str(number), '        (', num2str(round(full_match_percentage,1)), '% match)'];
                    img = insertText(current_source_img,position,value,'AnchorPoint','LeftTop', 'fontsize', 20, 'boxcolor','black','textcolor','white');
                    figure; imshow(img);              %% MATCH FOUND!
            ...
            elseif strcmp(match_method, 'distance')
                ...
                if full_match_percentage > MEC_DISTANCE_THRESHOLD
                    position =  [0 0];
                    value = ['Person: ' num2str(person), ', finger: ' num2str(finger), ', photo: ' num2str(number), '        (', num2str(round(full_match_percentage,1)), '% match)'];
                    img = insertText(current_source_img,position,value,'AnchorPoint','LeftTop', 'fontsize', 20, 'boxcolor','black','textcolor','white');
                    figure; imshow(img);              %% MATCH FOUND!
